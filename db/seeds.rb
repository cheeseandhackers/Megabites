...
ingredients: "1 (12 ounce) box Barilla® Gluten Free Spaghetti
* ½ pound ground beef 1 slice gluten free bread ⅓ cup milk Salt and black pepper to taste 1 egg yolk  ½ cup grated Parmigiano Reggiano cheese.",

instructions: 'In a large bowl, combine gluten free bread and milk. Let bread soak, then squeeze out excess milk. In the same bowl, add bread, egg, ground beef, 1/2 the parsley, 1/2 the cheese, and season with salt and pepper. Roll into 3/4 inch balls &amp; set aside. In a large skillet, gently cook the garlic and chili flakes in olive oil. Add meatballs and cook thoroughly. Add the cherry tomatoes and saute for 2 minutes, then season with salt and pepper to taste. Deglaze with wine and reduce mixture by half. Cook the pasta according to package directions, then reserve 1/2 cup of the cooking liquid. Drain the pasta then toss with the sauce and add the reserved cooking liquid. Cook the pasta in the sauce for one minute, remove the skillet from the heat and fold in the remaining cheese and parsley.',
...
instructions:"Preheat oven to 425 degrees F (220 degrees C). Oil a baking sheet with 1 tablespoon olive oil. Mix flour, cornmeal, and salt together in a bowl. Toss onion in flour mixture until coated. Spread onion mixture onto prepared baking sheet. Drizzle remaining oil over onion. Bake in the preheated oven, tossing onions occasionally, until crisped and golden, about 30 minutes.",

ready_in: 45 minutes,

cooking_minutes: 30 minutes,
...
ingredients: '1 (16 ounce) package bulk pork sausage
1 medium red bell pepper, chopped1 medium onion, chopped3 cups frozen hash brown potatoes2 cups shredded Cheddar cheese¾ cup Bisquick™ Gluten Free mix2 cups milk¼ teaspoon pepper',


instructions:"Heat oven to 400 degrees F. Spray 13x9-inch (3-quart) glass baking dish with cooking spray. In 10-inch skillet, cook sausage, bell pepper and onion over medium heat, stirring occasionally, until sausage is no longer pink; drain. Mix sausage mixture, potatoes and 1 1/2 cups of the cheese in baking dish. In medium bowl, stir Bisquick mix, milk, pepper and eggs until blended. Pour over sausage mixture in baking dish. Bake 30 to 35 minutes or until knife inserted in center comes out clean. Sprinkle with remaining 1/2 cup cheese. Bake about 3 minutes longer or until cheese is melted. Let stand 5 minutes before serving.",


ready_in: 55 minutes,

cooking_minutes: 35 minutes,
...
instructions: "preheat oven to 400 degrees F (200 degrees C). Grease a pizza pan or baking sheet. Beat almond milk, eggs, and oil together in a bowl. Mix rice flour, tapioca flour, xanthan gum, salt, and pepper together in a separate bowl. Add to the egg mixture and blend dough until smooth. Spread dough onto the prepared pan, using a flat spoon to make a 12-inch circle with raised edges. Bake in the preheated oven until lightly golden, about 15 minutes. Remove from oven and add your choice of toppings. Return to the oven until crispy, about 15 minutes more.",
...
instructions:"Grease a 9x13-inch baking dish and set aside. Heat a skillet over medium-high heat and add oil, onion, and bell pepper. Cook until onion is soft and translucent, about 5 minutes. Remove from heat. Heat a second skillet over medium-high heat and cook chorizo until browned on the outside, about 5 minutes. Continue cooking, chopping chorizo with a spatula, until it becomes loose like ground meat, about 5 minutes more. Drain and discard grease. Set aside. Whisk eggs, milk, mustard, salt, and pepper together in a large bowl. Stir in 1 1/2 cups Cheddar cheese, cooked onion mixture, chorizo, and hash brown potatoes. Pour mixture into the prepared baking dish, cover with aluminum foil, and refrigerate overnight. Remove casserole from the refrigerator 30 minutes ahead of time. Preheat the oven to 350 degrees F (175 degrees C). Bake covered casserole in the preheated oven for 30 minutes. Uncover and sprinkle remaining 1/2 cup Cheddar cheese on top. Return to the oven and bake until a fork inserted in the middle comes out clean, about 30 minutes more.",

ready_in: 9 hrs,

cooking_minutes: 1 hour,
...
instructions: "Heat olive oil in a large skillet over low heat and cook garlic until softened, about 10 minutes. Add zucchini and zucchini blossoms; mix well with olive oil. Add chickpeas and stir to combine. Season with salt and stir in basil. Serve immediately.",
ready_in_minutes: 25,
cooking_minutes: 15,
diet_type: vegan
},
...
instructions: "Preheat oven to 400 degrees F (200 degrees C). Spread potatoes, zucchini, and red onions in a 9x13-inch baking dish, or preferably a larger one. Use 2 baking dishes if necessary. Cover with pureed tomatoes, olive oil, parsley. Season with salt and freshly ground pepper. Toss all ingredients together so that the vegetables are evenly coated. Bake in the preheated oven, stirring after 1 hour, until vegetables are tender and moisture has evaporated, about 90 minutes. Cool slightly before serving, or serve at room temperature.",
...
ingredients: "2 tbsp. extra virgin olive oil, 1/2 onion finely chopped, 4 cloves garlic minced, 1 tsp ground cumin, 1 tsp chili powder, 2 cups shredded chicken, 2/3 cup enchilada sauce, 4 tbsp chopped cilantro, kosher salt to taste, 2 cups shredded cheddar, 2 cups shredded monterey jack, sour cream 4 servings.",
ready_in_minutes: 45,
cookTime: 15,
diet_type: "keto"
]
